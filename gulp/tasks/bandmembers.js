...
module.exports = function(gulp, plugins) {
    return function () {
        log('start bandmembers');
// -------------------------------------------- Start Task
// ---- move js files
        var copyfiles_index =
            gulp.src(config.images.bandmembers.src)
                ...
                .pipe(imagemin())
                .pipe(gulp.dest(config.images.bandmembers.dest));
        var copyfiles_thumb =
            gulp.src(config.images.bandmembers.src)
                .pipe(sharpResponsive({
                    formats: [
                ...
                .pipe(imagemin())
                .pipe(gulp.dest(config.images.bandmembers.dest + 'thumb'));
        var copyfiles_sm =
            gulp.src(config.images.bandmembers.src)
                .pipe(sharpResponsive({
                    formats: [
                ...
                .pipe(imagemin())
                .pipe(gulp.dest(config.images.bandmembers.dest + 'sm'));
        var copyfiles_md =
            gulp.src(config.images.bandmembers.src)
                .pipe(sharpResponsive({
                    formats: [
                ...
                .pipe(imagemin())
                .pipe(gulp.dest(config.images.bandmembers.dest + 'md'));
        var copyfiles_lg =
            gulp.src(config.images.bandmembers.src)
                .pipe(sharpResponsive({
                    formats: [
                ...
                .pipe(imagemin())
                .pipe(gulp.dest(config.images.bandmembers.dest + 'lg'));
// ---------------------------------------------- End Task
        log('----------------');
