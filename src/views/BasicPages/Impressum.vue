<template>
  <div id="impressum">
    ...
    <ul class="nolist">
      <li v-if="basicinfo.company"><b>{{basicinfo.company}}</b></li>
    ...
    <p v-if="basicinfo.winhaber.length > 0">
      <strong>Inhaber: </strong>
      <ul class="nolist">
        <li v-for="inhaber in basicinfo.winhaber" :key="inhaber">{{inhaber}}</li>
      </ul>
    </p>
    ...
    <p>
      ...
      der Benutzung der Website durch Sie ermöglicht. Die durch den Cookie
      ...
      dort gespeichert. Google wird diese Informationen benutzen, um Ihre Nutzung
    ...
    <br>
      Impressum vom <a target="_blank" href="https://www.impressum-generator.de">Impressum Generator</a> der <a href="https://www.kanzlei-hasselbach.de/">Kanzlei Hasselbach, Rechtsanwälte für Arbeitsrecht und Familienrecht</a>
  </div>
</template>
...
export default {
  ...
  computed: {
    basicinfo() {
      ...
      // console.log("basicinfo()", impressum);
      return impressum;
    }
  }
}
