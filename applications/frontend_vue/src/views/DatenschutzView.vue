<template>
  <div id="datenschutz">
    ...
    <ul class="nolist">
      <li v-if="basicinfo.company">
        <b>{{ basicinfo.company }}</b>
      </li>
      <li v-if="basicinfo.inhaber">{{ basicinfo.inhaber }}</li>
      <li v-if="basicinfo.street">{{ basicinfo.street }}</li>
      <li v-if="basicinfo.zip">{{ basicinfo.zip }}</li>
      <li v-if="basicinfo.town">{{ basicinfo.town }}</li>
    </ul>
    <p>
      ...
      Daten. Diese Daten sind absolut Personen unabhängig und werden genutzt, um Ihnen die Webseiten
      korrekt darzustellen und werden bei jeder Nutzung des Internets abgerufen. Die absolut
      anonymen Daten werden statistisch ausgewertet um unseren Service für Sie zu verbessern.
    </p>
    <p>
      ...
      Änderungen, Aktualisierungen oder andere relevante Informationen unterrichtet zu werden.<br />
      Bei der Anmeldung muss eine gültige E-Mail-Adresse angegeben werden. Über das sogenannte
      „double-opt-in“ Verfahren wird geprüft, ob Anmelder und E-Mail übereinstimmen.<br />
      Sie haben das Recht, ihre Daten für den Newsletterdienst jederzeit löschen zu lassen. In
      unseren Newslettern finden Sie einen Link zur Abmeldung. Außerdem können Sie sich auf der
      Webseite abmelden oder uns ihren Wunsch über unsere Kontaktseite mitteilen.
    </p>
    <p>
    ...
    <p>
      <strong>Löschung oder Sperrung von Daten</strong><br />
    ...
    <p>
      ...
      Nutzung unserer Webseite werden an einen Google Server in die USA übertragen und gespeichert.
      Da auf unseren Webseiten eine IP-Anonymisierung aktiviert ist, wird Ihre IP-Adresse von Google
      gekürzt. Dies gilt für Mitgliedstaaten der Europäischen Union und anderen Vertragsstaaten des
      Abkommens über den Europäischen Wirtschaftsraum. In seltenen Fällen kann es vorkommen, dass
      die volle IP-Adresse an einen Google Server in den USA übertragen und erst dort gekürzt wird.
      Google nutzt diese Informationen um Ihre Nutzung unserer Webseite auszuwerten, um für uns
      Berichte über die Nutzung der Webseite zusammenzustellen und um weitere statistische Daten zu
      erheben. Ihre IP-Adresse wird dabei niemals mit anderen auf Google gespeicherten Daten
      zusammengeführt. Die Verwendung von Cookies kann durch eine Einstellung in ihrem Browser
      verboten werden; dies kann jedoch unter Umständen die Funktion unserer Webseite
      beeinträchtigen. Mittels eines speziellen Zusatzprogramms für ihren Browser (Add On) können
      Sie die Sammlung von Daten durch Google Analytics desaktivieren.
    </p>
    <p>
      ...
      und Internet Verbindung werden dabei übertragen.<br />
      ...
      richtig funktionieren, wenn die Verwendung von Cookies desaktiviert ist.
    </p>
    <p>
      <strong>Skalierbares Zentrales Messverfahren</strong><br />
      Für die Sammlung statistischer Kennwerte über die Nutzung unserer Dienste nutzen wir das
      „Skalierbare Zentrale Messverfahren“ (SZM) der INFOnline GmbH http://www.infonline.de)<br />
      ...
      genutzt.<br />
      Bei der Reichweitenmessung wird der Datenschutz stets berücksichtigt. Diese ermittelt
      statistisch die Nutzungsintensität und die Zahl der Nutzer einer Website. Dabei werden
      einzelne Nutzer nicht erkannt, die Identität bleibt stets geschützt. Das System versendet
      keine Werbung.<br />
      ...
      http://www.agma-mmc.de und http://www.ivw.eu eingesehen werden. die IVW überprüft das
      SZM-Verfahren regelmäßig im Hinblick auf eine regel- und datenschutzkonforme Nutzung, außerdem
      werden die Messdaten veröffentlicht.<br />
      ...
      detaillierte Informationen zum SZM-Verfahren.<br />
    ...
    <p>
      <strong>Auskunft, Berichtigung, Sperre, Löschung und Widerspruch</strong><br />
      ...
      verlangen. Innerhalb der Archivierungsverpflichtung können wir Ihre Daten auf Wunsch
      sperren.<br />
    ...
    <p>
      <strong>Änderung der Datenschutzbestimmungen</strong><br />
      Unsere Datenschutzerklärung können in unregelmäßigen Abständen angepasst werden, damit sie den
      aktuellen rechtlichen Anforderungen entsprechen oder um Änderungen unserer Dienstleistungen
      umzusetzen, z. B. bei der Einfügung neuer Angebote. Für Ihren nächsten Besuch gilt dann
      automatisch die neue Datenschutzerklärung.
    </p>
    <p>
      <strong>Kontakt zum Datenschutzmitarbeiter</strong><br />
      Für Fragen zum Datenschutz schicken Sie uns bitte eine Nachricht an max@muster.de mit dem
      Betreff „Datenschutz“.<br /><br /><br />
      Diese Widerrufsbelehrung Seite wurde bei
      <a href="https://datenschutzerklärunggenerator.de/" target="_blank">
